 ...
 * Use the [ToysFragment.newInstance] factory method to
...
class ToysFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var recyclerView2 = view.findViewById<RecyclerView>(R.id.toysRecyclerView)
        var layoutManager2= LinearLayoutManager(view.context)
        recyclerView2.layoutManager=layoutManager2
        val query: Query = FirebaseFirestore.getInstance().collection("toys")
        ...
        adapter.setOnItemClickListener(object : NoteAdapter.OnItemClickListener {
            override fun onItemClick(documentSnapshot: DocumentSnapshot?, position: Int) {
                ...
                myIntent.putExtra("colName","toys")
