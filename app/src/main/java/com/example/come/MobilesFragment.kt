...
class BlankFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mobiles, container, false)
        var recyclerView2 = view.findViewById<RecyclerView>(R.id.mobilesRecyclerView)
        var layoutManager2= LinearLayoutManager(view.context)
        recyclerView2.layoutManager=layoutManager2
        val query: Query = FirebaseFirestore.getInstance().collection("mobiles")
        ...
        adapter.setOnItemClickListener(object : NoteAdapter.OnItemClickListener {
            override fun onItemClick(documentSnapshot: DocumentSnapshot?, position: Int) {
                ...
                myIntent.putExtra("colName","mobiles")
